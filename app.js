...
function initNotifications() {
  ...
  notifBell.addEventListener("click", (e) => {
    // Only toggle if bell or icon inside clicked (not elements in popover)
  ...
  if (!notifications) {
    notifications = [
      {
        id: 1,
        title: "Google Deal Closed",
        desc: "Enterprise package deal closed won.",
        time: "10 mins ago",
        unread: true,
      },
      {
        ...
        desc: "Microsoft Corporation added contacts.",
        time: "1 hr ago",
        unread: true,
      },
      {
        ...
        desc: "Amazon Services invoice #INV-4921 paid.",
        time: "3 hrs ago",
        unread: false,
      },
      {
        ...
        desc: "Sync scheduled with Netflix team at 10 AM.",
        time: "5 hrs ago",
        unread: true,
      },
    ];
...
function renderNotificationsList(notifications) {
  ...
  if (notifications.length === 0) {
    listContainer.innerHTML =
      '<div class="notif-empty">You have no notifications</div>';
    return;
  }
...
function updateThemeIcon(theme) {
  ...
  if (theme === "light") {
    // If Lucide is active, change attribute or content
  ...
  // Re-render icons if Lucide object is loaded in scope
...
// Global hook to access toast from page scripts
